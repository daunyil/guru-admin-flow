...
import type { summarizeAttendance } from "@guru-admin/domain";

/** Attendance status values. */
export type Status = "present" | "sick" | "excused" | "absent" | "late";
...
export const statusButtons: Array<{ value: Status; short: string; active: string }> = [
